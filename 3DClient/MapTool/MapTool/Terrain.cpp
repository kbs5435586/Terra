...
HRESULT CTerrain::Ready_Component()
{
	...
	m_pBufferCom = (CBuffer_Terrain*)pManagement->Clone_Component(SCENE_STATIC, L"Component_Buffer_Terrain");
	...
	m_pNaviCom = (CNavi*)pManagement->Clone_Component(SCENE_STATIC, L"Component_NaviMesh");
...
//			return;
//
//		m_pBufferCom = (CBuffer_Terrain*)pManagement->Clone_Component(SCENE_STATIC, pSecond->m_pTerrainTool->m_pOutput_Component_tag);
//		if (FAILED(Add_Component(L"Com_Buffer", m_pBufferCom)))
//			return;
//
//		Safe_Release(pManagement);

...
HRESULT CMainApp::Ready_MainApp()
{
	...
	m_pManagement->Set_Graphic_Device(m_pGraphic_Device);
	return S_OK;
}
...
HRESULT CMainApp::Ready_Prototype_GameObject()
{
	...
	if (FAILED(m_pManagement->Add_Prototype_Component(SCENE_STATIC, L"Component_Buffer_RcTex", CBuffer_RcTex::Create(m_pGraphic_Device))))
		return E_FAIL;
	if (FAILED(m_pManagement->Add_Prototype_Component(SCENE_STATIC, L"Component_Buffer_CubeWire", CBuffer_CubeWire::Create(m_pGraphic_Device))))
		return E_FAIL;
	return S_OK;
}

...
public:
	...
	const _matrix* Find_Frame(const char* pFrameName) const
	{
		D3DXFRAME_DERIVED* temp= ((D3DXFRAME_DERIVED*)D3DXFrameFind(m_pRootFrame, pFrameName));
		if (!temp)
			return nullptr;
		return &temp->CombinedTransformationMatrix;
	}
public:

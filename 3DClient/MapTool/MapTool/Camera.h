...
public:
	HRESULT SetUp_CameraProjDesc(const CAMERADESC& CameraDesc, const PROJDESC& ProjDesc, const CAMERADESC& EffectCameraDesc);
...
protected:
	...
	PROJDESC		m_ProjDesc;
protected:
	CTransform*		m_pEffectCameraTransform = nullptr;
	_matrix			m_matEffectView;
	CAMERADESC		m_EffectCameraDesc;
private:

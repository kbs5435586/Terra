...
CHill::CHill(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CHill::CHill(const CHill & rhs)
	: CGameObject(rhs)
{
}

HRESULT CHill::Ready_Prototype()
{
	return S_OK;
}

HRESULT CHill::Ready_GameObject(void * pArg)
{
...
_int CHill::Update_GameObject(const _float & fTimeDelta)
{
...
_int CHill::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
CHill * CHill::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CHill* pInstance = new CHill(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CHill::Clone_GameObject(void * pArg)
{
	CHill* pInstance = new CHill(*this);
...
HRESULT CHill::Ready_Component()
{
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_STATIC, L"Component_StaticMesh_Hill0");
...
HRESULT CHill::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

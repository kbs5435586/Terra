...
HRESULT CNPC::Ready_Component()
{
	...
	// For.Com_Mesh
	m_pMeshCom = (CDynamic_Mesh*)pManagement->Clone_Component(SCENE_STATIC, L"Component_Mesh_NPC");
	...
	D3DXMatrixScaling(&matLocalTransform, 15.f, 60.f, 15.f);
	matLocalTransform._42 = 30.f;
...
HRESULT CNPC::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const D3DXMESHCONTAINER_DERIVED * pMeshContainer, const _uint & iAttributeID)
{

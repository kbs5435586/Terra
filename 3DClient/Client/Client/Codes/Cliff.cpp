...
CCliff::CCliff(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CCliff::CCliff(const CCliff & rhs)
	: CGameObject(rhs)
{

}

HRESULT CCliff::Ready_Prototype()
{
	return S_OK;
}

HRESULT CCliff::Ready_GameObject(void * pArg)
{
...
_int CCliff::Update_GameObject(const _float & fTimeDelta)
{
...
_int CCliff::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
CCliff * CCliff::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CCliff* pInstance = new CCliff(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CCliff::Clone_GameObject(void * pArg)
{
	CCliff* pInstance = new CCliff(*this);
...
HRESULT CCliff::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_STATIC, L"Component_StaticMesh_Cliff0");
...
HRESULT CCliff::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

...
HRESULT CFlower::Ready_Prototype()
{
	return S_OK;
}
...
_int CFlower::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
HRESULT CFlower::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_STATIC, L"Component_StaticMesh_Flower0");
...
HRESULT CFlower::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

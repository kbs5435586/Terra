...
_int CRock::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
HRESULT CRock::Ready_Component()
{
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_STATIC, L"Component_StaticMesh_Rock0");
...
HRESULT CRock::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

...
HRESULT CHouse::Ready_Prototype()
{
	return S_OK;
}

HRESULT CHouse::Ready_GameObject(void * pArg)
{
...
CGameObject * CHouse::Clone_GameObject(void * pArg)
{
...
HRESULT CHouse::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_STATIC, L"Component_StaticMesh_House0");
...
HRESULT CHouse::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

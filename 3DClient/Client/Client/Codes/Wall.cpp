...
_int CWall::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
HRESULT CWall::Ready_Component()
{
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_STATIC, L"Component_StaticMesh_Wall0");
...
HRESULT CWall::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

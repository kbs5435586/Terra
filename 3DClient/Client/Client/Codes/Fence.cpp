...
CFence::CFence(const CFence & rhs)
	: CGameObject(rhs)
{
}

HRESULT CFence::Ready_Prototype()
{
	return S_OK;
}

HRESULT CFence::Ready_GameObject(void * pArg)
{
	_tchar* pComponentTag = (_tchar*)pArg;
...
_int CFence::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
CGameObject * CFence::Clone_GameObject(void * pArg)
{
...
HRESULT CFence::Ready_Component(const _tchar* pComponentTag)
{
	CManagement* pManagement = CManagement::GetInstance();
...
HRESULT CFence::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

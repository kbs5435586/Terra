...
{
private:
	CWaveRing(LPDIRECT3DDEVICE9 pGraphic_Device);
	CWaveRing(const CWaveRing& rhs);
	virtual ~CWaveRing() = default;
public:
...
public:
	static	CWaveRing* Create(LPDIRECT3DDEVICE9 pGraphic_Device);

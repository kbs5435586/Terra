...
CGrass16::CGrass16(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CGrass16::CGrass16(const CGrass16 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CGrass16::Ready_Prototype()
{
	return S_OK;
}

HRESULT CGrass16::Ready_GameObject(void * pArg)
{
...
_int CGrass16::Update_GameObject(const _float & fTimeDelta)
{
...
_int CGrass16::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CGrass16::Render_GameObject()
{
...
CGrass16 * CGrass16::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CGrass16* pInstance = new CGrass16(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CGrass16::Clone_GameObject(void * pArg)
{
	CGrass16* pInstance = new CGrass16(*this);
...
HRESULT CGrass16::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Grass16");
...
HRESULT CGrass16::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

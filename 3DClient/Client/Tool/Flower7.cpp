...
CFlower7::CFlower7(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CFlower7::CFlower7(const CFlower7 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CFlower7::Ready_Prototype()
{
	return S_OK;
}

HRESULT CFlower7::Ready_GameObject(void * pArg)
{
...
_int CFlower7::Update_GameObject(const _float & fTimeDelta)
{
...
_int CFlower7::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CFlower7::Render_GameObject()
{
...
CFlower7 * CFlower7::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CFlower7* pInstance = new CFlower7(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CFlower7::Clone_GameObject(void * pArg)
{
	CFlower7* pInstance = new CFlower7(*this);
...
HRESULT CFlower7::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Flower7");
...
HRESULT CFlower7::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

...
CGrass15::CGrass15(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CGrass15::CGrass15(const CGrass15 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CGrass15::Ready_Prototype()
{
	return S_OK;
}

HRESULT CGrass15::Ready_GameObject(void * pArg)
{
...
_int CGrass15::Update_GameObject(const _float & fTimeDelta)
{
...
_int CGrass15::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CGrass15::Render_GameObject()
{
...
CGrass15 * CGrass15::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CGrass15* pInstance = new CGrass15(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CGrass15::Clone_GameObject(void * pArg)
{
	CGrass15* pInstance = new CGrass15(*this);
...
HRESULT CGrass15::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Grass15");
...
HRESULT CGrass15::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

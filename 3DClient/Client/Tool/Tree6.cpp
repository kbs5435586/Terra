...
CTree6::CTree6(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CTree6::CTree6(const CTree6 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree6::Ready_Prototype()
{
	return S_OK;
}

HRESULT CTree6::Ready_GameObject(void * pArg)
{
...
_int CTree6::Update_GameObject(const _float & fTimeDelta)
{
...
_int CTree6::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
CTree6 * CTree6::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CTree6* pInstance = new CTree6(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CTree6::Clone_GameObject(void * pArg)
{
	CTree6* pInstance = new CTree6(*this);
...
HRESULT CTree6::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Tree6");
...
HRESULT CTree6::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

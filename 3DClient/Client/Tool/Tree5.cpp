...
CTree5::CTree5(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CTree5::CTree5(const CTree5 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree5::Ready_Prototype()
{
	return S_OK;
}

HRESULT CTree5::Ready_GameObject(void * pArg)
{
...
_int CTree5::Update_GameObject(const _float & fTimeDelta)
{
...
_int CTree5::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
CTree5 * CTree5::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CTree5* pInstance = new CTree5(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CTree5::Clone_GameObject(void * pArg)
{
	CTree5* pInstance = new CTree5(*this);
...
HRESULT CTree5::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Tree5");
...
HRESULT CTree5::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

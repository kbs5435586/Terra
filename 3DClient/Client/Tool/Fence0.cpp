...
CFence0::CFence0(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CFence0::CFence0(const CFence0 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CFence0::Ready_Prototype()
{
	return S_OK;
}

HRESULT CFence0::Ready_GameObject(void * pArg)
{
	...
	if (nullptr != pArg)
	{
		...
		m_pTransformCom->Set_StateInfo(STATE_POSITION, &_vec3(vPos.x, vPos.y+1.f, vPos.z));
	}
...
_int CFence0::Update_GameObject(const _float & fTimeDelta)
{
...
_int CFence0::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CFence0::Render_GameObject()
{
...
CFence0 * CFence0::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CFence0* pInstance = new CFence0(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CFence0::Clone_GameObject(void * pArg)
{
	CFence0* pInstance = new CFence0(*this);
...
HRESULT CFence0::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Fence0");
...
HRESULT CFence0::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

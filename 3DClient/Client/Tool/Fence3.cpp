...
CFence3::CFence3(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CFence3::CFence3(const CFence3 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CFence3::Ready_Prototype()
{
	return S_OK;
}

HRESULT CFence3::Ready_GameObject(void * pArg)
{
...
_int CFence3::Update_GameObject(const _float & fTimeDelta)
{
...
_int CFence3::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CFence3::Render_GameObject()
{
...
CFence3 * CFence3::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CFence3* pInstance = new CFence3(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CFence3::Clone_GameObject(void * pArg)
{
	CFence3* pInstance = new CFence3(*this);
...
HRESULT CFence3::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Fence3");
...
HRESULT CFence3::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

...
CCliff3::CCliff3(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CCliff3::CCliff3(const CCliff3 & rhs)
	: CGameObject(rhs)
{

}

HRESULT CCliff3::Ready_Prototype()
{
	return S_OK;
}

HRESULT CCliff3::Ready_GameObject(void * pArg)
{
...
_int CCliff3::Update_GameObject(const _float & fTimeDelta)
{
...
_int CCliff3::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CCliff3::Render_GameObject()
{
...
CCliff3 * CCliff3::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CCliff3* pInstance = new CCliff3(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CCliff3::Clone_GameObject(void * pArg)
{
	CCliff3* pInstance = new CCliff3(*this);
...
HRESULT CCliff3::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Cliff3");
...
HRESULT CCliff3::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

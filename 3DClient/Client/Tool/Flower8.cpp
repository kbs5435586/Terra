...
CFlower8::CFlower8(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CFlower8::CFlower8(const CFlower8 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CFlower8::Ready_Prototype()
{
	return S_OK;
}

HRESULT CFlower8::Ready_GameObject(void * pArg)
{
...
_int CFlower8::Update_GameObject(const _float & fTimeDelta)
{
...
_int CFlower8::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CFlower8::Render_GameObject()
{
...
CFlower8 * CFlower8::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CFlower8* pInstance = new CFlower8(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CFlower8::Clone_GameObject(void * pArg)
{
	CFlower8* pInstance = new CFlower8(*this);
...
HRESULT CFlower8::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Flower8");
...
HRESULT CFlower8::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

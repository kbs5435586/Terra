...
CFence4::CFence4(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CFence4::CFence4(const CFence4 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CFence4::Ready_Prototype()
{
	return S_OK;
}

HRESULT CFence4::Ready_GameObject(void * pArg)
{
...
_int CFence4::Update_GameObject(const _float & fTimeDelta)
{
...
_int CFence4::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CFence4::Render_GameObject()
{
...
CFence4 * CFence4::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CFence4* pInstance = new CFence4(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CFence4::Clone_GameObject(void * pArg)
{
	CFence4* pInstance = new CFence4(*this);
...
HRESULT CFence4::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Fence4");
...
HRESULT CFence4::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

...
CFence2::CFence2(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CFence2::CFence2(const CFence2 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CFence2::Ready_Prototype()
{
	return S_OK;
}

HRESULT CFence2::Ready_GameObject(void * pArg)
{
...
_int CFence2::Update_GameObject(const _float & fTimeDelta)
{
...
_int CFence2::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CFence2::Render_GameObject()
{
...
CFence2 * CFence2::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CFence2* pInstance = new CFence2(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CFence2::Clone_GameObject(void * pArg)
{
	CFence2* pInstance = new CFence2(*this);
...
HRESULT CFence2::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Fence2");
...
HRESULT CFence2::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

...
CWall6::CWall6(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CWall6::CWall6(const CWall6 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CWall6::Ready_Prototype()
{
	return S_OK;
}

HRESULT CWall6::Ready_GameObject(void * pArg)
{
...
_int CWall6::Update_GameObject(const _float & fTimeDelta)
{
...
_int CWall6::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
CWall6 * CWall6::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CWall6* pInstance = new CWall6(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CWall6::Clone_GameObject(void * pArg)
{
	CWall6* pInstance = new CWall6(*this);
...
HRESULT CWall6::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Wall6");
...
HRESULT CWall6::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

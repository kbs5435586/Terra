...
CHill0::CHill0(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CHill0::CHill0(const CHill0 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CHill0::Ready_Prototype()
{
	return S_OK;
}

HRESULT CHill0::Ready_GameObject(void * pArg)
{
...
_int CHill0::Update_GameObject(const _float & fTimeDelta)
{
...
_int CHill0::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
CHill0 * CHill0::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CHill0* pInstance = new CHill0(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CHill0::Clone_GameObject(void * pArg)
{
	CHill0* pInstance = new CHill0(*this);
...
HRESULT CHill0::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Hill0");
...
HRESULT CHill0::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

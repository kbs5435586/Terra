...
private:
	CUD_Worker(LPDIRECT3DDEVICE9 pGraphic_Device);
	CUD_Worker(const CUD_Worker& rhs);
	virtual ~CUD_Worker() = default;
public:
...
public:
	static	CUD_Worker*		Create(LPDIRECT3DDEVICE9 pGraphic_Device);

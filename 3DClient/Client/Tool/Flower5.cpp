...
CFlower5::CFlower5(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CFlower5::CFlower5(const CFlower5 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CFlower5::Ready_Prototype()
{
	return S_OK;
}

HRESULT CFlower5::Ready_GameObject(void * pArg)
{
...
_int CFlower5::Update_GameObject(const _float & fTimeDelta)
{
...
_int CFlower5::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CFlower5::Render_GameObject()
{
...
CFlower5 * CFlower5::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CFlower5* pInstance = new CFlower5(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CFlower5::Clone_GameObject(void * pArg)
{
	CFlower5* pInstance = new CFlower5(*this);
...
HRESULT CFlower5::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Flower5");
...
HRESULT CFlower5::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

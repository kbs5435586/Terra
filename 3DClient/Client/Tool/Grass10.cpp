...
CGrass10::CGrass10(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CGrass10::CGrass10(const CGrass10 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CGrass10::Ready_Prototype()
{
	return S_OK;
}

HRESULT CGrass10::Ready_GameObject(void * pArg)
{
...
_int CGrass10::Update_GameObject(const _float & fTimeDelta)
{
...
_int CGrass10::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CGrass10::Render_GameObject()
{
...
CGrass10 * CGrass10::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CGrass10* pInstance = new CGrass10(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CGrass10::Clone_GameObject(void * pArg)
{
	CGrass10* pInstance = new CGrass10(*this);
...
HRESULT CGrass10::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Grass10");
...
HRESULT CGrass10::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

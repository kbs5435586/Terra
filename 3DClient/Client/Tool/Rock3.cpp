...
CRock3::CRock3(LPDIRECT3DDEVICE9 pGraphic_Device)
...
CRock3 * CRock3::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CRock3* pInstance = new CRock3(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CRock3::Clone_GameObject(void * pArg)
{
...
HRESULT CRock3::Ready_Component()
{
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Rock3");
...
HRESULT CRock3::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

...
CGrass11::CGrass11(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CGrass11::CGrass11(const CGrass11 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CGrass11::Ready_Prototype()
{
	return S_OK;
}

HRESULT CGrass11::Ready_GameObject(void * pArg)
{
...
_int CGrass11::Update_GameObject(const _float & fTimeDelta)
{
...
_int CGrass11::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CGrass11::Render_GameObject()
{
...
CGrass11 * CGrass11::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CGrass11* pInstance = new CGrass11(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CGrass11::Clone_GameObject(void * pArg)
{
	CGrass11* pInstance = new CGrass11(*this);
...
HRESULT CGrass11::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Grass11");
...
HRESULT CGrass11::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

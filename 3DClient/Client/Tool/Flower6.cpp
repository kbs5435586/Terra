...
CFlower6::CFlower6(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CFlower6::CFlower6(const CFlower6 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CFlower6::Ready_Prototype()
{
	return S_OK;
}

HRESULT CFlower6::Ready_GameObject(void * pArg)
{
...
_int CFlower6::Update_GameObject(const _float & fTimeDelta)
{
...
_int CFlower6::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CFlower6::Render_GameObject()
{
...
CFlower6 * CFlower6::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CFlower6* pInstance = new CFlower6(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CFlower6::Clone_GameObject(void * pArg)
{
	CFlower6* pInstance = new CFlower6(*this);
...
HRESULT CFlower6::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Flower6");
...
HRESULT CFlower6::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

...
CFlower4::CFlower4(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CFlower4::CFlower4(const CFlower4 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CFlower4::Ready_Prototype()
{
	return S_OK;
}

HRESULT CFlower4::Ready_GameObject(void * pArg)
{
...
_int CFlower4::Update_GameObject(const _float & fTimeDelta)
{
...
_int CFlower4::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CFlower4::Render_GameObject()
{
...
CFlower4 * CFlower4::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CFlower4* pInstance = new CFlower4(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CFlower4::Clone_GameObject(void * pArg)
{
	CFlower4* pInstance = new CFlower4(*this);
...
HRESULT CFlower4::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Flower4");
...
HRESULT CFlower4::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

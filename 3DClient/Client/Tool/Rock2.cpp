...
CRock2::CRock2(LPDIRECT3DDEVICE9 pGraphic_Device)
...
CRock2 * CRock2::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CRock2* pInstance = new CRock2(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CRock2::Clone_GameObject(void * pArg)
{
...
HRESULT CRock2::Ready_Component()
{
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Rock2");
...
HRESULT CRock2::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

...
CWall5::CWall5(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CWall5::CWall5(const CWall5 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CWall5::Ready_Prototype()
{
	return S_OK;
}

HRESULT CWall5::Ready_GameObject(void * pArg)
{
...
_int CWall5::Update_GameObject(const _float & fTimeDelta)
{
...
_int CWall5::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
CWall5 * CWall5::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CWall5* pInstance = new CWall5(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CWall5::Clone_GameObject(void * pArg)
{
	CWall5* pInstance = new CWall5(*this);
...
HRESULT CWall5::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Wall5");
...
HRESULT CWall5::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

...
CFence6::CFence6(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CFence6::CFence6(const CFence6 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CFence6::Ready_Prototype()
{
	return S_OK;
}

HRESULT CFence6::Ready_GameObject(void * pArg)
{
...
_int CFence6::Update_GameObject(const _float & fTimeDelta)
{
...
_int CFence6::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CFence6::Render_GameObject()
{
...
CFence6 * CFence6::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CFence6* pInstance = new CFence6(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CFence6::Clone_GameObject(void * pArg)
{
	CFence6* pInstance = new CFence6(*this);
...
HRESULT CFence6::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Fence6");
...
HRESULT CFence6::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

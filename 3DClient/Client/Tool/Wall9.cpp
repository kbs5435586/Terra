...
CWall9::CWall9(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CWall9::CWall9(const CWall9 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CWall9::Ready_Prototype()
{
	return S_OK;
}

HRESULT CWall9::Ready_GameObject(void * pArg)
{
...
_int CWall9::Update_GameObject(const _float & fTimeDelta)
{
...
_int CWall9::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
CWall9 * CWall9::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CWall9* pInstance = new CWall9(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CWall9::Clone_GameObject(void * pArg)
{
	CWall9* pInstance = new CWall9(*this);
...
HRESULT CWall9::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Wall9");
...
HRESULT CWall9::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

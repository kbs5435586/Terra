...
CRock1::CRock1(LPDIRECT3DDEVICE9 pGraphic_Device)
...
CRock1 * CRock1::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CRock1* pInstance = new CRock1(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CRock1::Clone_GameObject(void * pArg)
{
...
HRESULT CRock1::Ready_Component()
{
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Rock1");
...
HRESULT CRock1::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

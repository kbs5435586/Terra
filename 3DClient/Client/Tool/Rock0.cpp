...
CRock0::CRock0(LPDIRECT3DDEVICE9 pGraphic_Device)
...
CRock0 * CRock0::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CRock0* pInstance = new CRock0(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CRock0::Clone_GameObject(void * pArg)
{
...
HRESULT CRock0::Ready_Component()
{
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Rock0");
...
HRESULT CRock0::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

...
{
private:
	CFlower10(LPDIRECT3DDEVICE9 pGraphic_Device);
	CFlower10(const CFlower10& rhs);
	virtual ~CFlower10() = default;
public:
...
public:
	static	CFlower10*		Create(LPDIRECT3DDEVICE9 pGraphic_Device);

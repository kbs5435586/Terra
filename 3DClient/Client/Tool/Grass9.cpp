...
CGrass9::CGrass9(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CGrass9::CGrass9(const CGrass9 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CGrass9::Ready_Prototype()
{
	return S_OK;
}

HRESULT CGrass9::Ready_GameObject(void * pArg)
{
...
_int CGrass9::Update_GameObject(const _float & fTimeDelta)
{
...
_int CGrass9::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CGrass9::Render_GameObject()
{
...
CGrass9 * CGrass9::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CGrass9* pInstance = new CGrass9(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CGrass9::Clone_GameObject(void * pArg)
{
	CGrass9* pInstance = new CGrass9(*this);
...
HRESULT CGrass9::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Grass9");
...
HRESULT CGrass9::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

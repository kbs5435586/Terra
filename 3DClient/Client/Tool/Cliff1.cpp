...
CCliff1::CCliff1(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CCliff1::CCliff1(const CCliff1 & rhs)
	: CGameObject(rhs)
{

}

HRESULT CCliff1::Ready_Prototype()
{
	return S_OK;
}

HRESULT CCliff1::Ready_GameObject(void * pArg)
{
...
_int CCliff1::Update_GameObject(const _float & fTimeDelta)
{
...
_int CCliff1::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CCliff1::Render_GameObject()
{
...
CCliff1 * CCliff1::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CCliff1* pInstance = new CCliff1(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CCliff1::Clone_GameObject(void * pArg)
{
	CCliff1* pInstance = new CCliff1(*this);
...
HRESULT CCliff1::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Cliff1");
...
HRESULT CCliff1::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

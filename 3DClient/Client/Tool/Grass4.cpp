...
CGrass4::CGrass4(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CGrass4::CGrass4(const CGrass4 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CGrass4::Ready_Prototype()
{
	return S_OK;
}

HRESULT CGrass4::Ready_GameObject(void * pArg)
{
...
_int CGrass4::Update_GameObject(const _float & fTimeDelta)
{
...
_int CGrass4::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CGrass4::Render_GameObject()
{
...
CGrass4 * CGrass4::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CGrass4* pInstance = new CGrass4(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CGrass4::Clone_GameObject(void * pArg)
{
	CGrass4* pInstance = new CGrass4(*this);
...
HRESULT CGrass4::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Grass4");
...
HRESULT CGrass4::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

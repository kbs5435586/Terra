...
CGrass1::CGrass1(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CGrass1::CGrass1(const CGrass1 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CGrass1::Ready_Prototype()
{
	return S_OK;
}

HRESULT CGrass1::Ready_GameObject(void * pArg)
{
...
_int CGrass1::Update_GameObject(const _float & fTimeDelta)
{
...
_int CGrass1::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CGrass1::Render_GameObject()
{
...
CGrass1 * CGrass1::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CGrass1* pInstance = new CGrass1(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CGrass1::Clone_GameObject(void * pArg)
{
	CGrass1* pInstance = new CGrass1(*this);
...
HRESULT CGrass1::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Grass1");
...
HRESULT CGrass1::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

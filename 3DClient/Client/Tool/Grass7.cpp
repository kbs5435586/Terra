...
CGrass7::CGrass7(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CGrass7::CGrass7(const CGrass7 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CGrass7::Ready_Prototype()
{
	return S_OK;
}

HRESULT CGrass7::Ready_GameObject(void * pArg)
{
...
_int CGrass7::Update_GameObject(const _float & fTimeDelta)
{
...
_int CGrass7::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CGrass7::Render_GameObject()
{
...
CGrass7 * CGrass7::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CGrass7* pInstance = new CGrass7(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CGrass7::Clone_GameObject(void * pArg)
{
	CGrass7* pInstance = new CGrass7(*this);
...
HRESULT CGrass7::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Grass7");
...
HRESULT CGrass7::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

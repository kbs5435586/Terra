...
CSkHouse2::CSkHouse2(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CSkHouse2::CSkHouse2(const CSkHouse2 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CSkHouse2::Ready_Prototype()
{
	return S_OK;
}

HRESULT CSkHouse2::Ready_GameObject(void * pArg)
{
...
_int CSkHouse2::Update_GameObject(const _float & fTimeDelta)
{
...
_int CSkHouse2::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CSkHouse2::Render_GameObject()
{
...
CSkHouse2 * CSkHouse2::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CSkHouse2* pInstance = new CSkHouse2(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CSkHouse2::Clone_GameObject(void * pArg)
{
	CSkHouse2* pInstance = new CSkHouse2(*this);
...
HRESULT CSkHouse2::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_SkHouse2");
...
HRESULT CSkHouse2::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

...
CTree1::CTree1(LPDIRECT3DDEVICE9 pGraphic_Device)
...
CTree1 * CTree1::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CTree1* pInstance = new CTree1(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CTree1::Clone_GameObject(void * pArg)
{
...
HRESULT CTree1::Ready_Component()
{
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Tree1");
...
HRESULT CTree1::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

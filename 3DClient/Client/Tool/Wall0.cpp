...
CWall0::CWall0(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CWall0::CWall0(const CWall0 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CWall0::Ready_Prototype()
{
	return S_OK;
}

HRESULT CWall0::Ready_GameObject(void * pArg)
{
...
_int CWall0::Update_GameObject(const _float & fTimeDelta)
{
...
_int CWall0::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
CWall0 * CWall0::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CWall0* pInstance = new CWall0(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CWall0::Clone_GameObject(void * pArg)
{
	CWall0* pInstance = new CWall0(*this);
...
HRESULT CWall0::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Wall0");
...
HRESULT CWall0::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

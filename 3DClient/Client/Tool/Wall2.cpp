...
CWall2::CWall2(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CWall2::CWall2(const CWall2 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CWall2::Ready_Prototype()
{
	return S_OK;
}

HRESULT CWall2::Ready_GameObject(void * pArg)
{
...
_int CWall2::Update_GameObject(const _float & fTimeDelta)
{
...
_int CWall2::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
CWall2 * CWall2::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CWall2* pInstance = new CWall2(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CWall2::Clone_GameObject(void * pArg)
{
	CWall2* pInstance = new CWall2(*this);
...
HRESULT CWall2::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Wall2");
...
HRESULT CWall2::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

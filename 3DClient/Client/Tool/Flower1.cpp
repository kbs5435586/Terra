...
CFlower1::CFlower1(LPDIRECT3DDEVICE9 pGraphic_Device)
...
CFlower1 * CFlower1::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CFlower1* pInstance = new CFlower1(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CFlower1::Clone_GameObject(void * pArg)
{
...
HRESULT CFlower1::Ready_Component()
{
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Flower1");
...
HRESULT CFlower1::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

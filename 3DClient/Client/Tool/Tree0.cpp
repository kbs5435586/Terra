...
CTree0::CTree0(LPDIRECT3DDEVICE9 pGraphic_Device)
...
CTree0 * CTree0::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CTree0* pInstance = new CTree0(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CTree0::Clone_GameObject(void * pArg)
{
...
HRESULT CTree0::Ready_Component()
{
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Tree0");
...
HRESULT CTree0::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

...
CGrass19::CGrass19(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CGrass19::CGrass19(const CGrass19 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CGrass19::Ready_Prototype()
{
	return S_OK;
}

HRESULT CGrass19::Ready_GameObject(void * pArg)
{
...
_int CGrass19::Update_GameObject(const _float & fTimeDelta)
{
...
_int CGrass19::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CGrass19::Render_GameObject()
{
...
CGrass19 * CGrass19::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CGrass19* pInstance = new CGrass19(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CGrass19::Clone_GameObject(void * pArg)
{
	CGrass19* pInstance = new CGrass19(*this);
...
HRESULT CGrass19::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Grass19");
...
HRESULT CGrass19::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

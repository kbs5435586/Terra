...
CFlower0::CFlower0(LPDIRECT3DDEVICE9 pGraphic_Device)
...
CFlower0 * CFlower0::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CFlower0* pInstance = new CFlower0(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CFlower0::Clone_GameObject(void * pArg)
{
...
HRESULT CFlower0::Ready_Component()
{
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Flower0");
...
HRESULT CFlower0::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

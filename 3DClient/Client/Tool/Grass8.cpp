...
CGrass8::CGrass8(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CGrass8::CGrass8(const CGrass8 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CGrass8::Ready_Prototype()
{
	return S_OK;
}

HRESULT CGrass8::Ready_GameObject(void * pArg)
{
...
_int CGrass8::Update_GameObject(const _float & fTimeDelta)
{
...
_int CGrass8::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CGrass8::Render_GameObject()
{
...
CGrass8 * CGrass8::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CGrass8* pInstance = new CGrass8(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CGrass8::Clone_GameObject(void * pArg)
{
	CGrass8* pInstance = new CGrass8(*this);
...
HRESULT CGrass8::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Grass8");
...
HRESULT CGrass8::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

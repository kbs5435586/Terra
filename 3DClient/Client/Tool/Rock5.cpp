...
CRock5::CRock5(LPDIRECT3DDEVICE9 pGraphic_Device)
...
CRock5 * CRock5::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CRock5* pInstance = new CRock5(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CRock5::Clone_GameObject(void * pArg)
{
...
HRESULT CRock5::Ready_Component()
{
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Rock5");
...
HRESULT CRock5::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

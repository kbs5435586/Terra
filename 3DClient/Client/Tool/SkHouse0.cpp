...
CSkHouse0::CSkHouse0(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CSkHouse0::CSkHouse0(const CSkHouse0 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CSkHouse0::Ready_Prototype()
{
	return S_OK;
}

HRESULT CSkHouse0::Ready_GameObject(void * pArg)
{
...
_int CSkHouse0::Update_GameObject(const _float & fTimeDelta)
{
...
_int CSkHouse0::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CSkHouse0::Render_GameObject()
{
...
CSkHouse0 * CSkHouse0::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CSkHouse0* pInstance = new CSkHouse0(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CSkHouse0::Clone_GameObject(void * pArg)
{
	CSkHouse0* pInstance = new CSkHouse0(*this);
...
HRESULT CSkHouse0::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_SkHouse0");
...
HRESULT CSkHouse0::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

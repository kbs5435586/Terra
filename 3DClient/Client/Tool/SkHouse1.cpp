...
CSkHouse1::CSkHouse1(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CSkHouse1::CSkHouse1(const CSkHouse1 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CSkHouse1::Ready_Prototype()
{
	return S_OK;
}

HRESULT CSkHouse1::Ready_GameObject(void * pArg)
{
...
_int CSkHouse1::Update_GameObject(const _float & fTimeDelta)
{
...
_int CSkHouse1::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CSkHouse1::Render_GameObject()
{
...
CSkHouse1 * CSkHouse1::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CSkHouse1* pInstance = new CSkHouse1(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CSkHouse1::Clone_GameObject(void * pArg)
{
	CSkHouse1* pInstance = new CSkHouse1(*this);
...
HRESULT CSkHouse1::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_SkHouse1");
...
HRESULT CSkHouse1::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

...
CHill2::CHill2(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CHill2::CHill2(const CHill2 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CHill2::Ready_Prototype()
{
	return S_OK;
}

HRESULT CHill2::Ready_GameObject(void * pArg)
{
...
_int CHill2::Update_GameObject(const _float & fTimeDelta)
{
...
_int CHill2::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
CHill2 * CHill2::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CHill2* pInstance = new CHill2(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CHill2::Clone_GameObject(void * pArg)
{
	CHill2* pInstance = new CHill2(*this);
...
HRESULT CHill2::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Hill2");
...
HRESULT CHill2::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

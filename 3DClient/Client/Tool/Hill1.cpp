...
CHill1::CHill1(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CHill1::CHill1(const CHill1 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CHill1::Ready_Prototype()
{
	return S_OK;
}

HRESULT CHill1::Ready_GameObject(void * pArg)
{
...
_int CHill1::Update_GameObject(const _float & fTimeDelta)
{
...
_int CHill1::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
CHill1 * CHill1::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CHill1* pInstance = new CHill1(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CHill1::Clone_GameObject(void * pArg)
{
	CHill1* pInstance = new CHill1(*this);
...
HRESULT CHill1::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Hill1");
...
HRESULT CHill1::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

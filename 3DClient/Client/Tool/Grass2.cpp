...
CGrass2::CGrass2(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CGrass2::CGrass2(const CGrass2 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CGrass2::Ready_Prototype()
{
	return S_OK;
}

HRESULT CGrass2::Ready_GameObject(void * pArg)
{
...
_int CGrass2::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
CGrass2 * CGrass2::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CGrass2* pInstance = new CGrass2(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CGrass2::Clone_GameObject(void * pArg)
{
	CGrass2* pInstance = new CGrass2(*this);
...
HRESULT CGrass2::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Grass2");
...
HRESULT CGrass2::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

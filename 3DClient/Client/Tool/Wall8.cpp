...
CWall8::CWall8(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CWall8::CWall8(const CWall8 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CWall8::Ready_Prototype()
{
	return S_OK;
}

HRESULT CWall8::Ready_GameObject(void * pArg)
{
...
_int CWall8::Update_GameObject(const _float & fTimeDelta)
{
...
_int CWall8::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
CWall8 * CWall8::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CWall8* pInstance = new CWall8(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CWall8::Clone_GameObject(void * pArg)
{
	CWall8* pInstance = new CWall8(*this);
...
HRESULT CWall8::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Wall8");
...
HRESULT CWall8::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

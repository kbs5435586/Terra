...
CCliff0::CCliff0(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CCliff0::CCliff0(const CCliff0 & rhs)
	: CGameObject(rhs)
{

}

HRESULT CCliff0::Ready_Prototype()
{
	return S_OK;
}

HRESULT CCliff0::Ready_GameObject(void * pArg)
{
...
_int CCliff0::Update_GameObject(const _float & fTimeDelta)
{
...
_int CCliff0::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CCliff0::Render_GameObject()
{
...
CCliff0 * CCliff0::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CCliff0* pInstance = new CCliff0(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CCliff0::Clone_GameObject(void * pArg)
{
	CCliff0* pInstance = new CCliff0(*this);
...
HRESULT CCliff0::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Cliff0");
...
HRESULT CCliff0::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

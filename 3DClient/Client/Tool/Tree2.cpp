...
CTree2::CTree2(LPDIRECT3DDEVICE9 pGraphic_Device)
...
CTree2 * CTree2::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CTree2* pInstance = new CTree2(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CTree2::Clone_GameObject(void * pArg)
{
...
HRESULT CTree2::Ready_Component()
{
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Tree2");
...
HRESULT CTree2::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

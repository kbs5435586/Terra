...
CGrass17::CGrass17(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CGrass17::CGrass17(const CGrass17 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CGrass17::Ready_Prototype()
{
	return S_OK;
}

HRESULT CGrass17::Ready_GameObject(void * pArg)
{
...
_int CGrass17::Update_GameObject(const _float & fTimeDelta)
{
...
_int CGrass17::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CGrass17::Render_GameObject()
{
...
CGrass17 * CGrass17::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CGrass17* pInstance = new CGrass17(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CGrass17::Clone_GameObject(void * pArg)
{
	CGrass17* pInstance = new CGrass17(*this);
...
HRESULT CGrass17::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Grass17");
...
HRESULT CGrass17::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

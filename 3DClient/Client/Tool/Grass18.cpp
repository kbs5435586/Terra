...
CGrass18::CGrass18(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CGrass18::CGrass18(const CGrass18 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CGrass18::Ready_Prototype()
{
	return S_OK;
}

HRESULT CGrass18::Ready_GameObject(void * pArg)
{
...
_int CGrass18::Update_GameObject(const _float & fTimeDelta)
{
...
_int CGrass18::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CGrass18::Render_GameObject()
{
...
CGrass18 * CGrass18::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CGrass18* pInstance = new CGrass18(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CGrass18::Clone_GameObject(void * pArg)
{
	CGrass18* pInstance = new CGrass18(*this);
...
HRESULT CGrass18::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Grass18");
...
HRESULT CGrass18::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

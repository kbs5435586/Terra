...
CRock6::CRock6(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CRock6::CRock6(const CRock6 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRock6::Ready_Prototype()
{
	return S_OK;
}

HRESULT CRock6::Ready_GameObject(void * pArg)
{
...
_int CRock6::Update_GameObject(const _float & fTimeDelta)
{
...
_int CRock6::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
CRock6 * CRock6::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CRock6* pInstance = new CRock6(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CRock6::Clone_GameObject(void * pArg)
{
...
HRESULT CRock6::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Rock6");
...
HRESULT CRock6::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

...
CFlower2::CFlower2(LPDIRECT3DDEVICE9 pGraphic_Device)
...
CFlower2 * CFlower2::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CFlower2* pInstance = new CFlower2(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CFlower2::Clone_GameObject(void * pArg)
{
...
HRESULT CFlower2::Ready_Component()
{
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Flower2");
...
HRESULT CFlower2::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

...
CGrass13::CGrass13(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CGrass13::CGrass13(const CGrass13 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CGrass13::Ready_Prototype()
{
	return S_OK;
}

HRESULT CGrass13::Ready_GameObject(void * pArg)
{
...
_int CGrass13::Update_GameObject(const _float & fTimeDelta)
{
...
_int CGrass13::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CGrass13::Render_GameObject()
{
...
CGrass13 * CGrass13::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CGrass13* pInstance = new CGrass13(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CGrass13::Clone_GameObject(void * pArg)
{
	CGrass13* pInstance = new CGrass13(*this);
...
HRESULT CGrass13::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Grass13");
...
HRESULT CGrass13::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

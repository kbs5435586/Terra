...
CWall10::CWall10(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CWall10::CWall10(const CWall10 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CWall10::Ready_Prototype()
{
	return S_OK;
}

HRESULT CWall10::Ready_GameObject(void * pArg)
{
...
_int CWall10::Update_GameObject(const _float & fTimeDelta)
{
...
_int CWall10::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CWall10::Render_GameObject()
{
...
CWall10 * CWall10::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CWall10* pInstance = new CWall10(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CWall10::Clone_GameObject(void * pArg)
{
	CWall10* pInstance = new CWall10(*this);
...
HRESULT CWall10::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Wall10");
...
HRESULT CWall10::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

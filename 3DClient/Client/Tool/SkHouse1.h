...
{
private:
	CSkHouse1(LPDIRECT3DDEVICE9 pGraphic_Device);
	CSkHouse1(const CSkHouse1& rhs);
	virtual ~CSkHouse1() = default;
public:
...
public:
	static	CSkHouse1*		Create(LPDIRECT3DDEVICE9 pGraphic_Device);

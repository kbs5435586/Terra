...
CFlower9::CFlower9(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CFlower9::CFlower9(const CFlower9 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CFlower9::Ready_Prototype()
{
	return S_OK;
}

HRESULT CFlower9::Ready_GameObject(void * pArg)
{
...
_int CFlower9::Update_GameObject(const _float & fTimeDelta)
{
...
_int CFlower9::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CFlower9::Render_GameObject()
{
...
CFlower9 * CFlower9::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CFlower9* pInstance = new CFlower9(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CFlower9::Clone_GameObject(void * pArg)
{
	CFlower9* pInstance = new CFlower9(*this);
...
HRESULT CFlower9::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Flower9");
...
HRESULT CFlower9::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

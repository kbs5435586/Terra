...
CFlower3::CFlower3(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CFlower3::CFlower3(const CFlower3 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CFlower3::Ready_Prototype()
{
	return S_OK;
}

HRESULT CFlower3::Ready_GameObject(void * pArg)
{
...
_int CFlower3::Update_GameObject(const _float & fTimeDelta)
{
...
_int CFlower3::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CFlower3::Render_GameObject()
{
...
CFlower3 * CFlower3::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CFlower3* pInstance = new CFlower3(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CFlower3::Clone_GameObject(void * pArg)
{
	CFlower3* pInstance = new CFlower3(*this);
...
HRESULT CFlower3::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Flower3");
...
HRESULT CFlower3::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

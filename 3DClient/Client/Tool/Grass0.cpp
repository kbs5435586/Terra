...
CGrass0::CGrass0(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CGrass0::CGrass0(const CGrass0 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CGrass0::Ready_Prototype()
{
	return S_OK;
}

HRESULT CGrass0::Ready_GameObject(void * pArg)
{
...
_int CGrass0::Update_GameObject(const _float & fTimeDelta)
{
...
_int CGrass0::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CGrass0::Render_GameObject()
{
...
CGrass0 * CGrass0::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CGrass0* pInstance = new CGrass0(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CGrass0::Clone_GameObject(void * pArg)
{
	CGrass0* pInstance = new CGrass0(*this);
...
HRESULT CGrass0::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Grass0");
...
HRESULT CGrass0::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

...
CTree7::CTree7(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CTree7::CTree7(const CTree7 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CTree7::Ready_Prototype()
{
	return S_OK;
}

HRESULT CTree7::Ready_GameObject(void * pArg)
{
...
_int CTree7::Update_GameObject(const _float & fTimeDelta)
{
...
_int CTree7::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
CTree7 * CTree7::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CTree7* pInstance = new CTree7(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CTree7::Clone_GameObject(void * pArg)
{
	CTree7* pInstance = new CTree7(*this);
...
HRESULT CTree7::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Tree7");
...
HRESULT CTree7::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

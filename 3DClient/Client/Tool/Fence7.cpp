...
CFence7::CFence7(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CFence7::CFence7(const CFence7 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CFence7::Ready_Prototype()
{
	return S_OK;
}

HRESULT CFence7::Ready_GameObject(void * pArg)
{
...
_int CFence7::Update_GameObject(const _float & fTimeDelta)
{
...
_int CFence7::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CFence7::Render_GameObject()
{
...
CFence7 * CFence7::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CFence7* pInstance = new CFence7(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CFence7::Clone_GameObject(void * pArg)
{
	CFence7* pInstance = new CFence7(*this);
...
HRESULT CFence7::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Fence7");
...
HRESULT CFence7::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

...
CWall4::CWall4(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CWall4::CWall4(const CWall4 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CWall4::Ready_Prototype()
{
	return S_OK;
}

HRESULT CWall4::Ready_GameObject(void * pArg)
{
...
_int CWall4::Update_GameObject(const _float & fTimeDelta)
{
...
_int CWall4::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
CWall4 * CWall4::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CWall4* pInstance = new CWall4(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CWall4::Clone_GameObject(void * pArg)
{
	CWall4* pInstance = new CWall4(*this);
...
HRESULT CWall4::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Wall4");
...
HRESULT CWall4::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

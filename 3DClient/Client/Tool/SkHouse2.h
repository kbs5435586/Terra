...
{
private:
	CSkHouse2(LPDIRECT3DDEVICE9 pGraphic_Device);
	CSkHouse2(const CSkHouse2& rhs);
	virtual ~CSkHouse2() = default;
public:
...
public:
	static	CSkHouse2*		Create(LPDIRECT3DDEVICE9 pGraphic_Device);

...
CTree4::CTree4(LPDIRECT3DDEVICE9 pGraphic_Device)
...
CTree4 * CTree4::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CTree4* pInstance = new CTree4(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CTree4::Clone_GameObject(void * pArg)
{
...
HRESULT CTree4::Ready_Component()
{
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Tree4");
...
HRESULT CTree4::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

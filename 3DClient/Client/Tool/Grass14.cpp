...
CGrass14::CGrass14(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CGrass14::CGrass14(const CGrass14 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CGrass14::Ready_Prototype()
{
	return S_OK;
}

HRESULT CGrass14::Ready_GameObject(void * pArg)
{
...
_int CGrass14::Update_GameObject(const _float & fTimeDelta)
{
...
_int CGrass14::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CGrass14::Render_GameObject()
{
...
CGrass14 * CGrass14::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CGrass14* pInstance = new CGrass14(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CGrass14::Clone_GameObject(void * pArg)
{
	CGrass14* pInstance = new CGrass14(*this);
...
HRESULT CGrass14::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Grass14");
...
HRESULT CGrass14::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

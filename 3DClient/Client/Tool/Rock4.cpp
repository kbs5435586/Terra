...
CRock4::CRock4(LPDIRECT3DDEVICE9 pGraphic_Device)
...
CRock4 * CRock4::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CRock4* pInstance = new CRock4(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CRock4::Clone_GameObject(void * pArg)
{
...
HRESULT CRock4::Ready_Component()
{
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Rock4");
...
HRESULT CRock4::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

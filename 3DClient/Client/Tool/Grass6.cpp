...
CGrass6::CGrass6(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CGrass6::CGrass6(const CGrass6 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CGrass6::Ready_Prototype()
{
	return S_OK;
}

HRESULT CGrass6::Ready_GameObject(void * pArg)
{
...
_int CGrass6::Update_GameObject(const _float & fTimeDelta)
{
...
_int CGrass6::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CGrass6::Render_GameObject()
{
...
CGrass6 * CGrass6::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CGrass6* pInstance = new CGrass6(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CGrass6::Clone_GameObject(void * pArg)
{
	CGrass6* pInstance = new CGrass6(*this);
...
HRESULT CGrass6::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Grass6");
...
HRESULT CGrass6::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

...
CTree3::CTree3(LPDIRECT3DDEVICE9 pGraphic_Device)
...
CTree3 * CTree3::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CTree3* pInstance = new CTree3(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CTree3::Clone_GameObject(void * pArg)
{
...
HRESULT CTree3::Ready_Component()
{
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Tree3");
...
HRESULT CTree3::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

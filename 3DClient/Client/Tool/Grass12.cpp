...
CGrass12::CGrass12(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CGrass12::CGrass12(const CGrass12 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CGrass12::Ready_Prototype()
{
	return S_OK;
}

HRESULT CGrass12::Ready_GameObject(void * pArg)
{
...
_int CGrass12::Update_GameObject(const _float & fTimeDelta)
{
...
_int CGrass12::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CGrass12::Render_GameObject()
{
...
CGrass12 * CGrass12::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CGrass12* pInstance = new CGrass12(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CGrass12::Clone_GameObject(void * pArg)
{
	CGrass12* pInstance = new CGrass12(*this);
...
HRESULT CGrass12::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Grass12");
...
HRESULT CGrass12::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

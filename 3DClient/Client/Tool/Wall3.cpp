...
CWall3::CWall3(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CWall3::CWall3(const CWall3 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CWall3::Ready_Prototype()
{
	return S_OK;
}

HRESULT CWall3::Ready_GameObject(void * pArg)
{
...
_int CWall3::Update_GameObject(const _float & fTimeDelta)
{
...
_int CWall3::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
CWall3 * CWall3::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CWall3* pInstance = new CWall3(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CWall3::Clone_GameObject(void * pArg)
{
	CWall3* pInstance = new CWall3(*this);
...
HRESULT CWall3::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Wall3");
...
HRESULT CWall3::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

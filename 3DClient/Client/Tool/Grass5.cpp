...
CGrass5::CGrass5(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CGrass5::CGrass5(const CGrass5 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CGrass5::Ready_Prototype()
{
	return S_OK;
}

HRESULT CGrass5::Ready_GameObject(void * pArg)
{
...
_int CGrass5::Update_GameObject(const _float & fTimeDelta)
{
...
_int CGrass5::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CGrass5::Render_GameObject()
{
...
CGrass5 * CGrass5::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CGrass5* pInstance = new CGrass5(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CGrass5::Clone_GameObject(void * pArg)
{
	CGrass5* pInstance = new CGrass5(*this);
...
HRESULT CGrass5::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Grass5");
...
HRESULT CGrass5::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

...
CFence1::CFence1(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CFence1::CFence1(const CFence1 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CFence1::Ready_Prototype()
{
	return S_OK;
}

HRESULT CFence1::Ready_GameObject(void * pArg)
{
...
_int CFence1::Update_GameObject(const _float & fTimeDelta)
{
...
_int CFence1::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CFence1::Render_GameObject()
{
...
CFence1 * CFence1::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CFence1* pInstance = new CFence1(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CFence1::Clone_GameObject(void * pArg)
{
	CFence1* pInstance = new CFence1(*this);
...
HRESULT CFence1::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Fence1");
...
HRESULT CFence1::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

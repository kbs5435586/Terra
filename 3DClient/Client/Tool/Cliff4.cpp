...
CCliff4::CCliff4(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CCliff4::CCliff4(const CCliff4 & rhs)
	: CGameObject(rhs)
{

}

HRESULT CCliff4::Ready_Prototype()
{
	return S_OK;
}

HRESULT CCliff4::Ready_GameObject(void * pArg)
{
...
_int CCliff4::Update_GameObject(const _float & fTimeDelta)
{
...
_int CCliff4::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CCliff4::Render_GameObject()
{
...
CCliff4 * CCliff4::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CCliff4* pInstance = new CCliff4(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CCliff4::Clone_GameObject(void * pArg)
{
	CCliff4* pInstance = new CCliff4(*this);
...
HRESULT CCliff4::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Cliff4");
...
HRESULT CCliff4::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

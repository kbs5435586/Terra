...
CWall7::CWall7(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CWall7::CWall7(const CWall7 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CWall7::Ready_Prototype()
{
	return S_OK;
}

HRESULT CWall7::Ready_GameObject(void * pArg)
{
...
_int CWall7::Update_GameObject(const _float & fTimeDelta)
{
...
_int CWall7::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
CWall7 * CWall7::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CWall7* pInstance = new CWall7(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CWall7::Clone_GameObject(void * pArg)
{
	CWall7* pInstance = new CWall7(*this);
...
HRESULT CWall7::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Wall7");
...
HRESULT CWall7::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

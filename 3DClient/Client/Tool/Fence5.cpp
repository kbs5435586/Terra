...
CFence5::CFence5(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CFence5::CFence5(const CFence5 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CFence5::Ready_Prototype()
{
	return S_OK;
}

HRESULT CFence5::Ready_GameObject(void * pArg)
{
...
_int CFence5::Update_GameObject(const _float & fTimeDelta)
{
...
_int CFence5::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CFence5::Render_GameObject()
{
...
CFence5 * CFence5::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CFence5* pInstance = new CFence5(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CFence5::Clone_GameObject(void * pArg)
{
	CFence5* pInstance = new CFence5(*this);
...
HRESULT CFence5::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Fence5");
...
HRESULT CFence5::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

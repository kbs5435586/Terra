...
CFlower10::CFlower10(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CFlower10::CFlower10(const CFlower10 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CFlower10::Ready_Prototype()
{
	return S_OK;
}

HRESULT CFlower10::Ready_GameObject(void * pArg)
{
...
_int CFlower10::Update_GameObject(const _float & fTimeDelta)
{
...
_int CFlower10::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CFlower10::Render_GameObject()
{
...
CFlower10 * CFlower10::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CFlower10* pInstance = new CFlower10(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CFlower10::Clone_GameObject(void * pArg)
{
	CFlower10* pInstance = new CFlower10(*this);
...
HRESULT CFlower10::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Flower10");
...
HRESULT CFlower10::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

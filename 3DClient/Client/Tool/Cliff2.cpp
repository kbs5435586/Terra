...
CCliff2::CCliff2(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CCliff2::CCliff2(const CCliff2 & rhs)
	: CGameObject(rhs)
{

}

HRESULT CCliff2::Ready_Prototype()
{
	return S_OK;
}

HRESULT CCliff2::Ready_GameObject(void * pArg)
{
...
_int CCliff2::Update_GameObject(const _float & fTimeDelta)
{
...
_int CCliff2::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CCliff2::Render_GameObject()
{
...
CCliff2 * CCliff2::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CCliff2* pInstance = new CCliff2(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CCliff2::Clone_GameObject(void * pArg)
{
	CCliff2* pInstance = new CCliff2(*this);
...
HRESULT CCliff2::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Cliff2");
...
HRESULT CCliff2::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

...
CGrass3::CGrass3(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CGrass3::CGrass3(const CGrass3 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CGrass3::Ready_Prototype()
{
	return S_OK;
}

HRESULT CGrass3::Ready_GameObject(void * pArg)
{
...
_int CGrass3::Update_GameObject(const _float & fTimeDelta)
{
...
_int CGrass3::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CGrass3::Render_GameObject()
{
...
CGrass3 * CGrass3::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CGrass3* pInstance = new CGrass3(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CGrass3::Clone_GameObject(void * pArg)
{
	CGrass3* pInstance = new CGrass3(*this);
...
HRESULT CGrass3::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Grass3");
...
HRESULT CGrass3::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

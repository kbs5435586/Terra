...
CWall1::CWall1(LPDIRECT3DDEVICE9 pGraphic_Device)
...
HRESULT CWall1::Ready_Prototype()
{
	return S_OK;
}

HRESULT CWall1::Ready_GameObject(void * pArg)
{
...
_int CWall1::Update_GameObject(const _float & fTimeDelta)
{
...
_int CWall1::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
CWall1 * CWall1::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CWall1* pInstance = new CWall1(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CWall1::Clone_GameObject(void * pArg)
{
	CWall1* pInstance = new CWall1(*this);
...
HRESULT CWall1::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_Wall1");
...
HRESULT CWall1::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{

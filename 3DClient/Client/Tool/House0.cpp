...
CHouse0::CHouse0(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CHouse0::CHouse0(const CHouse0 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CHouse0::Ready_Prototype()
{
	return S_OK;
}

HRESULT CHouse0::Ready_GameObject(void * pArg)
{
...
_int CHouse0::Update_GameObject(const _float & fTimeDelta)
{
...
_int CHouse0::LastUpdate_GameObject(const _float & fTimeDelta)
{
...
void CHouse0::Render_GameObject()
{
...
CHouse0 * CHouse0::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CHouse0* pInstance = new CHouse0(pGraphic_Device);
	if (FAILED(pInstance->Ready_Prototype()))
		return nullptr;
	return pInstance;
}

CGameObject * CHouse0::Clone_GameObject(void * pArg)
{
	CHouse0* pInstance = new CHouse0(*this);
...
HRESULT CHouse0::Ready_Component()
{
	CManagement* pManagement = CManagement::GetInstance();
	...
	m_pMeshCom = (CStatic_Mesh*)pManagement->Clone_Component(SCENE_LOGO, L"Component_StaticMesh_House0");
...
HRESULT CHouse0::SetUp_ConstantTable(LPD3DXEFFECT pEffect, const _uint & iAttributeID)
{
